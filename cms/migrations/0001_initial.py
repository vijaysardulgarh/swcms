    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('GEN', 'General'), ('SC', 'SC'), ('BC-A', 'BC-A'), ('BC-B', 'BC-B'), ('EWS', 'EWS'), ('OTHER', 'OTHER')], max_length=50, null=True)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ...
                ('staff_role', models.CharField(blank=True, choices=[('Teaching', 'Teaching'), ('Non-Teaching', 'Non-Teaching')], max_length=20, null=True)),
                ('employment_type', models.CharField(blank=True, choices=[('Regular', 'Regular'), ('SSA', 'SSA'), ('Guest', 'Guest'), ('HKRNL', 'HKRNL'), ('NSQF', 'NSQF'), ('MDMWorker', 'MDM Worker'), ('Other', 'Other')], max_length=20, null=True)),
                ('bio', models.TextField(blank=True)),
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staff', to='cms.school')),
                ('subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Staff', to='cms.subject')),
                ('teaching_subject_1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teachers_1', to='cms.subject')),
                ('teaching_subject_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teachers_2', to='cms.subject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cms.class')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cms.subject')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cms.staff', to_field='employee_id')),
            ],
        ),
        migrations.CreateModel(
            name='DailyTimeSlot',
            fields=[
                ...
                ('end_time', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='end_time', to='cms.timeslot')),
                ('start_time', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='start_time', to='cms.timeslot')),
            ],
            options={
