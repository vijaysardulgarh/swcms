...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Staff', to='cms.subject'),
        ),
        migrations.CreateModel(
            name='ClassSubject',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cms.subject')),
                ('teachers', models.ManyToManyField(blank=True, limit_choices_to={'teaching_subject_1__in': django.db.models.expressions.OuterRef('subject')}, to='cms.staff')),
            ],
        ),
        migrations.CreateModel(
            name='TimetableSlot',
